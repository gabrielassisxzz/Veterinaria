...
namespace Veterinaria.view
{
    public partial class FrmLoja : Form
    {
        ...
        private void atualizaCampos()
        {
            ...
            cmbBairro.Text = lista_loja[posicao].bairro.ToString();
            cmbRua.Text = lista_loja[posicao].rua.ToString();
            cmbCEP.Text = lista_loja[posicao].cep.ToString();
            cmbCidade.Text = lista_loja[posicao].cidade.ToString();
            cmbEstado.Text = lista_loja[posicao].estado.ToString();
            cmbPais.Text = lista_loja[posicao].pais.ToString();
